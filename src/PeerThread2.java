 ...
 */
public class PeerThread2 implements Runnable {
    ...
    public PeerThread2(Socket psocket, boolean pisClient, int pid) throws IOException {
            ...
            while (!toStop) {
                ...
                switch (msgType) {
                    ...
                    case PIECE:
                        ...
                        for (PeerThread peerThread : peerProcess.listOfPeers) {
